...
function Laptop({ ...rest }) {
  ...
  return (
    <>
      <Container {...rest}>
        <div className="flex py-12 h-screen justify-between items-center login_main">
          <div className="w-1/2 flex flex-col justify-between items-center gap-7" >
            ...
            <form onSubmit={(e) => onsubmitForm(e)} className="w-full flex flex-col gap-5 items-center">
              ...
              <FloatingInput text='رمز عبور' title='pass' inputType='password'>
                <KeyRoundIcon
                  className="absolute right-3 top-[18px] text-gray-500 peer-focus:text-primary"
                  size={16}
                />
              ...
              <Button ColorBackground="bg-primary" color="text-white" className='hover:text-primary hover:bg-white border-2 w-full'>ورود</Button>
              <Link to="/singin">
                ثبت نام نکرده اید؟همین حالا <span className="text-primary">عضو</span> شوید
              </Link>
            </form>
          </div>
